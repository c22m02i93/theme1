        ...
        <div class="container-fluid">
            <div class="row">
                <header id="mpcth_archive_header">
                    ...
                    <h1 id="mpcth_archive_title" class=" zagolovok_straniz mpcth-deco-header" ><?php echo single_cat_title('', false); ?></h1>
                </header>
                                        ...
                                        if ( has_post_thumbnail() ) {
                                            ...
                                            if ( $attachments ) {
                                                foreach ( $attachments as $attachment ) {
                                                    echo wp_get_attachment_image( $attachment->ID, 'full', false, array('class' => '.mpcth-custom-image') );
                                                }
                                            }
                                        }
                                        ?>
