...
function mpcth_optionsframework_options() {
	$default_values = array(
		...
		'enableCopyrights' => '1',
		'copyrightText'    => __('Copyright MassivePixelCreation 2018', 'mpcth'),
	...
	$font_subsets = array(
		'default'      => __('Default ( Latin )', 'mpcth'),
		'cyrillic'     => __('Cyrillic', 'mpcth'),
		'cyrillic-ext' => __('Cyrillic Extended', 'mpcth'),
		'greek'        => __('Greek', 'mpcth'),
		'greek-ext'    => __('Greek Extended', 'mpcth'),
		'latin-ext'    => __('Latin Extended', 'mpcth'),
		'vietnamese'   => __('Vietnamese', 'mpcth')
	);
...
/* ---------------------------------------------------------------- */
		$options[] = array(
			"name" => __("Update", 'mpcth'),
			"type" => "accordion");

		$options['mpcth_purchase_code'] = array(
			"id" 	=> "mpcth_purchase_code",
			"name" 	=> __("Purchase Code", 'mpcth'),
			"desc" 	=> __("Add here theme purchase code. It can be found in your Envato Market account-&gt;Downloads-&gt;License certificate &amp; purchase code. Here is a link to <a href=\"https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-\" target=\"_blank\">Envato article</a>.", 'mpcth'),
			"type" 	=> "text",
			"std" 	=> "" );
...
/* ---------------------------------------------------------------- */
	...
	$options['mpcth_fav_icon'] = array(
		...
		"desc" 	=> __("Use the upload to upload your custom fav icon. To learn more about the Fav Icon please read <a href='https://en.wikipedia.org/wiki/Favicon' target='_blank'>this article</a>.", 'mpcth'),
...
/* ---------------------------------------------------------------- */
$options[] = array(
	"name" => __("WPBakery Page Builder", 'mpcth'),
	"type" => "accordion");

$options['mpcth_enable_wpbakery_license'] = array(
	"id" 	=> "mpcth_enable_wpbakery_license",
	"name" 	=> __("Enable WPBakery License Page", 'mpcth'),
	"desc" 	=> __('Check this option if you <strong>own an individual license</strong> for WPBakery and want to use their <a href="https://wpbakery.com/features/template-library/" target="_blank">templates library</a>. After enabling & saving Massive Panel, refresh wp-admin page or go directly to <a href="/wp-admin/admin.php?page=vc-updater">WPBakery Product License settings page</a>.', 'mpcth'),
	"type" 	=> "checkbox",
	"std" 	=> "0" );
...
/* ---------------------------------------------------------------- */
	$options[] = array(
		"name" => __("Font Subset", 'mpcth'),
		"type" => "accordion");

	$options['mpcth_font_subset'] = array(
		"id" 	  => "mpcth_font_subset",
		"name" 	  => __("Font Subset for your language", 'mpcth'),
		"desc"    => __("Specify font subset loaded with your selected Google Fonts.", 'mpcth'),
		"type" 	  => "select",
		"std" 	  => $default_values['fontSubset'],
...
/* ---------------------------------------------------------------- */
	...
	$options['mpcth_logo_width'] = array(
		"id" 	=> "mpcth_logo_width",
		"name" 	=> __("Logo Width", 'mpcth'),
		"desc" 	=> __('Specify your site logo width in pixels. Leave value empty for original size, but in SVG case it\'s required! Height will automatically adjust to keep original logo proportions.', 'mpcth'),
		"class" => "mpcth_logo_width",
		"type" 	=> "text",
		"std" 	=> "" );
	...
	$options['mpcth_logo_mobile_width'] = array(
		"id" 	=> "mpcth_logo_mobile_width",
		"name" 	=> __("Logo Mobile Width", 'mpcth'),
		"desc" 	=> __('Specify your site logo width in pixels. Leave value empty for original size, but in SVG case it\'s required! Height will automatically adjust to keep original logo proportions.', 'mpcth'),
		"class" => "mpcth_logo_width",
		"type" 	=> "text",
		"std" 	=> "" );
	...
	$options['mpcth_logo_sticky_width'] = array(
		"id" 	=> "mpcth_logo_sticky_width",
		"name" 	=> __("Logo Sticky Width", 'mpcth'),
		"desc" 	=> __('Specify your site logo width in pixels. Leave empty for original image size, but in SVG case it\'s required! Height will automatically adjust to keep original logo proportions.', 'mpcth'),
		"class" => "mpcth_logo_width",
		"type" 	=> "text",
		"std" 	=> "" );
...
/* ---------------------------------------------------------------- */
	...
	$options['mpcth_header_full_width'] = array(
		"id" 		=> "mpcth_header_full_width",
		"name" 		=> __("Enable Header Full Width", 'mpcth'),
		"desc" 		=> __("Specify if you want to display header & menu in full width.", 'mpcth'),
		"type" 		=> "checkbox",
		"std" 		=> "0" );
	...
	$options['mpcth_enable_accordion_menu'] = array(
		"id" 		=> "mpcth_enable_accordion_menu",
		"name" 		=> __("Enable Accordion Mobile Menu", 'mpcth'),
		"desc" 		=> __("Specify if you want to display Mobile Menu in accordion style. Submenu items will be collapsed from the start.", 'mpcth'),
		"type" 		=> "checkbox",
		"std" 		=> "0" );
...
/* ---------------------------------------------------------------- */
	...
	if ( class_exists( 'YITH_WCWL' ) ) {
		$options[ 'mpcth_header_secondary_wishlist_link' ] = array(
			"id"             => "mpcth_header_secondary_wishlist_link",
			"name"           => __( "Disable YITH WooCommerce Wishlist Link", 'mpcth' ),
			"desc"           => __( "Check this option to remove YITH WooCommerce Wishlist link from Secondary Header.", 'mpcth' ),
			"class"          => "secondary_header",
			"type"           => "checkbox",
			"std"            => 0,
			"additional_fun" => "hide"
	...
	if ( class_exists( 'WooCommerce' ) ) {
		$options[ 'mpcth_header_secondary_account_link' ] = array(
			"id"             => "mpcth_header_secondary_account_link",
			"name"           => __( "Disable WooCommerce My Account/Login Link", 'mpcth' ),
			"desc"           => __( "Check this option to remove WooCommerce My Account/Login Link from Secondary Header.", 'mpcth' ),
			"class"          => "secondary_header",
			"type"           => "checkbox",
			"std"            => 0,
			"additional_fun" => "hide"
	...
	if ( class_exists( 'SitePress' ) ) {
		$options[ 'mpcth_header_secondary_wpml_language' ] = array(
			"id"             => "mpcth_header_secondary_wpml_language",
			"name"           => __( "Enable WPML Language Switcher", 'mpcth' ),
			"desc"           => __( "Check this option to enable WPML Language Switcher in Secondary Header.", 'mpcth' ),
			"class"          => "secondary_header",
			"type"           => "checkbox",
			"std"            => 1,
			"additional_fun" => "hide",
			"hide_class"     => "wpml_language"
		);

		$options[ 'mpcth_header_secondary_wpml_language_default' ] = array(
			"id"             => "mpcth_header_secondary_wpml_language_default",
			"name"           => __( "Disable WPML Language Switcher Vanila Select Box Look", 'mpcth' ),
			"desc"           => __( "Check this option to change default demo WPML language switcher look into dropdown with flags support.", 'mpcth' ),
			"class"          => "secondary_header wpml_language",
			"type"           => "checkbox",
			"std"            => 1,
			"additional_fun" => "hide",
			"hide_class"     => "wpml_modern"
		);

		$options[ 'mpcth_header_secondary_wpml_language_native' ] = array(
			"id"             => "mpcth_header_secondary_wpml_language_native",
			"name"           => __( "Enable WPML Language Switcher Native Names", 'mpcth' ),
			"desc"           => __( "Check this option to display native language names inside switcher.", 'mpcth' ),
			"class"          => "secondary_header wpml_language",
			"type"           => "checkbox",
			"std"            => 1,
			"additional_fun" => "hide"
		...
		$options[ 'mpcth_header_secondary_wpml_language_flags' ] = array(
			"id"             => "mpcth_header_secondary_wpml_language_flags",
			"name"           => __( "Enable WPML Language Switcher Flags", 'mpcth' ),
			"desc"           => __( "Check this option to display national flags in switcher.", 'mpcth' ),
			"class"          => "secondary_header wpml_language wpml_modern",
			"type"           => "checkbox",
			"std"            => 1,
			"additional_fun" => "hide"
		);
		...
		if ( defined( 'WCML_VERSION' ) ) {
			$options[ 'mpcth_header_secondary_wpml_currency' ] = array(
				"id"             => "mpcth_header_secondary_wpml_currency",
				"name"           => __( "Enable WPML Currency Switcher", 'mpcth' ),
				"desc"           => __( "Check this option to enable WPML Currency Switcher in Secondary Header.", 'mpcth' ),
				"class"          => "secondary_header",
				"type"           => "checkbox",
				"std"            => 1,
				"additional_fun" => "hide",
				"hide_class"     => "wpml_currency"
			);

			$options[ 'mpcth_header_secondary_wpml_currency_default' ] = array(
				"id"             => "mpcth_header_secondary_wpml_currency_default",
				"name"           => __( "Disable WPML Currency Switcher Vanila Select Box Look", 'mpcth' ),
				"desc"           => __( "Check this option to change default demo WPML language switcher look into dropdown.", 'mpcth' ),
				"class"          => "secondary_header wpml_currency",
				"type"           => "checkbox",
				"std"            => 1,
				"additional_fun" => "hide"
			);

			$options[ 'mpcth_header_secondary_wpml_currency_code' ] = array(
				"id"             => "mpcth_header_secondary_wpml_currency_code",
				"name"           => __( "Switch Into Currency Code Format", 'mpcth' ),
				"desc"           => __( "Check this option to change WPML Currency Switcher format into currency code, in example \"($) USD\".", 'mpcth' ),
				"class"          => "secondary_header wpml_currency",
				"type"           => "checkbox",
				"std"            => 0,
				"additional_fun" => "hide"
...
/* ---------------------------------------------------------------- */
	...
	if( class_exists( 'RevSliderFront' ) ) {
		$options['mpcth_rev_nav_original'] = array(
			"id" 	=> "mpcth_rev_nav_original",
			"name" 	=> __("Slider Revolution Navigation Arrows in Blaszok Style ", 'mpcth'),
			"desc" 	=> __("Check this option if you want to overwrite Slider Revolution arrows to style seen on previews and in other carousels.", 'mpcth'),
			"type" 	=> "checkbox",
			"std" 	=> 1 );
	}
...
/* ---------------------------------------------------------------- */
	...
	if(isset($menu_id['mpcth_menu'])) {
		...
		$options[] = array(
				"name" => __("Mega Menu Dropdowns Backgrounds", 'mpcth'),
				"type" => "accordion" );

		$options['mpcth_dropdowns_info'] = array(
			"id" 	=> "mpcth_dropdowns_info",
			"name" 	=> __("There are no menu items to be used within Dropdowns Background!", 'mpcth'),
			"desc" 	=> __("First, make sure that MPC Mega Menu plugin is installed & Mega Menu enabled in Theme Options->Element->Header.<br>
						Mega Menu works like a widget. Go to Appearance->Widgets and place MPC - Mega Menu into Main Menu slot.<br>
						Now in the widget settings select your menu.<br>Please notice that menu needs to have 3 level structure ( main item->subheader->item ) as shown in a <a target=\"_blank\" href=\"https://blaszok.mpcthemes.net/docs/#megaMenu\">docs screenshot</a>.", 'mpcth'),
			"type" 	=> "info" );

		if ( $menu_items ) {
			$options['mpcth_dropdowns_info']['name'] = __("Please check quick guide how to setup Mega Menu.", 'mpcth');
...
/* ---------------------------------------------------------------- */
	...
	$options['mpcth_enable_new_badge'] = array(
		"id"			 => "mpcth_enable_new_badge",
		"name"			 => __("Enable New Product Badge", 'mpcth'),
		"desc"			 => __("Check this option if you want to enable the New product badge at archive and single product page.", 'mpcth'),
		"type"			 => "checkbox",
		"std"			 => "0",
		"additional_fun" => "hide",
		"hide_class"     => "mpcth_new_badge_time" );

	$options['mpcth_new_badge_time'] = array(
		"id" 			 => "mpcth_new_badge_time",
		"name" 			 => __("Number of Days", 'mpcth'),
		"desc" 			 => __("Use this field to set number of days for the New badge to appear. It is counted from Publish Date, so you can manipulate each product individually on Edit Product", 'mpcth'),
		"class"          => "mpcth_new_badge_time",
		"type" 			 => "text",
		"std" 			 => "14" );

	$options[ 'mpcth_single_product_additional' ] = array(
		"id"             => "mpcth_single_product_additional",
		"name"           => __( "Enable Single Product Additional Features", 'mpcth' ),
		"desc"           => __( "Check this option to enable build-in WooCommerce 3.0+ features: Zoom, Lightbox, Gallery Slider. Please note that this will disable Blaszok thumbnails carousel for main image on single product.", 'mpcth' ),
		"type"           => "checkbox",
		"std"            => "0",
		"additional_fun" => "hide",
		"hide_class"     => "mpcth_single_product" );

	$options[ 'mpcth_single_product_additional_zoom' ] = array(
		"id"             => "mpcth_single_product_additional_zoom",
		"name"           => __( "Enable Single Product Zoom", 'mpcth' ),
		"desc"           => __( "Check this option to enable WooCommerce Zoom for single product view.", 'mpcth' ),
		"class"          => "mpcth_single_product",
		"type"           => "checkbox",
		"std"            => "1",
		"additional_fun" => "hide" );

	$options[ 'mpcth_single_product_additional_lightbox' ] = array(
		"id"             => "mpcth_single_product_additional_lightbox",
		"name"           => __( "Enable Single Product Lightbox", 'mpcth' ),
		"desc"           => __( "Check this option to enable WooCommerce Lightbox for single product view.", 'mpcth' ),
		"class"          => "mpcth_single_product",
		"type"           => "checkbox",
		"std"            => "1",
		"additional_fun" => "hide" );
