...
<head>
  ...
  <?php endif; ?>
  <script src="https://kit.fontawesome.com/585355a55d.js" crossorigin="anonymous"></script>
          ...
          <div class="mpcth-header-wrap">
            <div id="mpcth_page_header_content" class="mpcth-header-order-<?php echo $header_order; ?>">
              ...
              <div id="mpcth_logo_wrap"
                class="<?php echo $mobile_logo || $mobile_logo_2x ? 'mpcth-mobile-logo-enabled' : ''; ?><?php echo $sticky_logo || $sticky_logo_2x ? ' mpcth-sticky-logo-enabled' : ''; ?>">
                <a id="mpcth_logo" href="<?php echo get_home_url(); ?>">
                  <img src="<?= get_stylesheet_directory_uri() ?>/images/verh-sajta.png">
                </a>
              ...
              <div id="mpcth_controls_wrap">
                <div id="mpcth_controls_container">
                  ...
                  <a id="mpcth_cart" href="<?php echo wc_get_cart_url(); ?>"
                    class="<?php echo sizeof( WC()->cart->get_cart() ) > 0 ? 'active' : ''; ?>">
                    <span class="mpcth-mini-cart-icon-info">
                      <?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) { ?>
                      <?php
															if ( isset( $mpcth_options['mpcth_subtotal_text'] ) ) {
																$subtotal = $mpcth_options['mpcth_subtotal_text'];
															} else {
																$subtotal = __( 'Subtotal:', 'mpcth' );
															}
															?>
                      <span class="mpcth-mini-cart-subtotal"><?php echo $subtotal; ?>
                  ...
                  <div id="mpcth_mini_search">
                    <form role="search" method="get" id="searchform" action="<?php echo home_url(); ?>">
                      ...
                      <input type="hidden" value="<?php echo apply_filters( 'wpml_current_language', null ); ?>"
                        name="lang" />
                      <?php } ?>
