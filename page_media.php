    ...
    <div id="mpcth_main_container">
        ...
        <div id="mpcth_content_wrap">
            ...
            <a class=" bat_kit btn btn-primary"
              href="https://mitropolia-simbirsk.ru/category/slovo-patriarha" role=" bat_akt_col"
              style="
background: rgba(19, 65, 135, 0.8);
">Слово Патриарха</a>

            <a class=" bat_kit btn btn-primary" href="https://mitropolia-simbirsk.ru/category/media/novosti"
              role=" bat_akt_col" style="
background: rgba(19, 65, 135, 0.8);
">События</a>

            <a class=" bat_kit btn btn-primary" href="https://mitropolia-simbirsk.ru/category/hronika"
              role=" bat_akt_col" style="
background: rgba(19, 65, 135, 0.8);
">Хроника</a>
								     <a class=" bat_kit btn btn-primary" href="https://mitropolia-simbirsk.ru/category/media/gazeta-pravoslavnyj-simbirsk"
              role=" bat_akt_col" style="
background: rgba(19, 65, 135, 0.8);
">Газета «Православный Симбирск»</a>
								   
								     <a class=" bat_kit btn btn-primary" href="https://mitropolia-simbirsk.ru/category/monitoring"
              role=" bat_akt_col" style="
background: rgba(19, 65, 135, 0.8);
">Публикации</a>
								   
								     <a class=" bat_kit btn btn-primary" href="https://mitropolia-simbirsk.ru/category/media/video"
              role=" bat_akt_col" style="
background: rgba(19, 65, 135, 0.8);
">Видео</a>
