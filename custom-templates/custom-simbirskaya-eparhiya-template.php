<?php
/**
 * Template Name: Simbirskaya Eparhiya Template
 *
						...
						<article id="page-<?php the_ID(); ?>" <?php post_class('mpcth-page'); ?> >
                            ...
                            <div class="bat_kit">
                                <a
                                  ...
                                  href="https://mitropolia-simbirsk.ru/mitropoliya/simbirskaya-eparhiya/simbirskaya-eparhiya-segodnya"
                                  role=" bat_akt_col"
                                  style="background: rgba(19, 65, 135, 0.8)"
                                  >Симбирская епархия сегодня</a
                                >
                              
                                <a
                                  class="bat_kit btn btn-primary"
                                  href="https://mitropolia-simbirsk.ru/mitropoliya/historisimbirskaya-eparhiya"
                                  role=" bat_akt_col"
                                  style="background: rgba(19, 65, 135, 0.8)"
                                  >История Симбирской епархии</a
                                >
                              
                                <a
                                  class="bat_kit btn btn-primary"
                                  href="https://mitropolia-simbirsk.ru/category/arhierei"
                                  role=" bat_akt_col"
                                  style="background: rgba(19, 65, 135, 0.8)"
                                  >Архиереи Симбирской епархии</a
                                >
